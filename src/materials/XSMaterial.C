...
XSMaterial::validParams()
{
  ...
  params.addRequiredParam<std::vector<Real>>("d0",
                                             "Diffusion coefficient for each Material for group 0");
  params.addRequiredParam<std::vector<Real>>("d1",
                                             "Diffusion coefficient for each Material for group 1");
  ...
  params.addRequiredCoupledVar("zone",
                               "A variable holding an integer for each element that specifies "
                               "which 'zone' that element is part of");
